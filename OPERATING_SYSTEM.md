...
├─ KNOWLEDGE ─── AI_SKILL_MAP · AI_PROGRESSION_PLAN · AI_LEARNING_RESOURCES · AI_7_SKILLS · AI_SKILLS_ACQUISITION · AI_TYPES · AI_CLAUDE_TOOL_SELECTOR · AI_RAG_DESIGN   ידע אישי/לימודי (on-demand)
...
| 14 | `AI_RAG_DESIGN.md` | Knowledge | ✅ פעיל | תכנון RAG — 15 טעויות Retrieval + פתרונות, ממופה ל-ULease |
...
| 1.0.2 | רישום `AI_RAG_DESIGN` (שורה 14, D-020) — מודול Knowledge לתכנון RAG, ממופה ל-Deal Score ול-Q&A Bot | 2026-06-01 |
