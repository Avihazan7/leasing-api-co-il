...
- `DECISION_LOG.md` v1.47.0 — יומן החלטות append-only: 60 החלטות (OS + ULease), רציונל וסטטוס.
...
9. `AI_*` + `AGENT_BLUEPRINT` + `CLOUD_ARCHITECT_SKILLS` (SKILL_MAP · PROGRESSION_PLAN · LEARNING_RESOURCES · 7_SKILLS · SKILLS_ACQUISITION · TYPES · CLAUDE_TOOL_SELECTOR · CLAUDE_STACK_2026 · CLAUDE_GLOSSARY · RAG_DESIGN · PROJECT_STRUCTURE · ROLES_2026 · CLAUDE_ENGINEER_ROADMAP · DATA_BI · SYSTEM_DESIGN · PROCESS_INTELLIGENCE · PROFICIENCIES_2026 · LINEAR_ALGEBRA · AGENT_BLUEPRINT · CLOUD_ARCHITECT_SKILLS · 10_SKILLS)  ← Knowledge (on-demand)
