...
- `DECISION_LOG.md` v1.21.0 — יומן החלטות append-only: 34 החלטות (OS + ULease), רציונל וסטטוס.
...
- `CASES/ULEASE_LAUNCH_CHECKLIST.md` v1.2.0 — צ'קליסט השקה (שבועיים): דומיין, משפטי, MVP, תוכן, outreach, QA ולוח שבועי.
