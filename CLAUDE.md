...
- `CTO_REVIEW.md` v1.1.0 — ביקורת CTO על ULease, תגובה מבוססת-קוד. הצלבת 10 נקודות הביקורת מול הקוד ב-`leasing-api`: תיקון 3 טענות (Event Bus / Data Warehouse / BI קיימים כ-seams), scorecard מתוקן, מפת דרכים P0–P7 ל-Platform v2.0; **שני צעדים ראשונים נחתו** (Decision Engine seam + Multi-Tenancy/RLS first increment, **63/63 טסטים**, תואמי-לאחור).
