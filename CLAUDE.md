...
- `AI_CLAUDE_TOOL_SELECTOR.md` v1.3.0 — "איזה Claude לבחור?": עץ החלטה ל-15 כלי Claude (Chat · Code · Cowork · Skills · Excel · Artifacts…), יכולות רוחב (§2.5: Vision · Voice · 1M · Research), מדד 12 הדרכים (§3.5: הציון 10.5/12), מודלים מומלצים + מנוף Effort, ומיפוי למשימות ה-OS ו-ULease.
