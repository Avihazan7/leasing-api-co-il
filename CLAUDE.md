...
- `DECISION_LOG.md` v1.23.0 — יומן החלטות append-only: 36 החלטות (OS + ULease), רציונל וסטטוס.
...
- `AI_SYSTEM_DESIGN.md` v1.0.0 — יסודות System Design: שער כניסה (Gateway·Proxy·LB), 6 סגנונות API, תורים (Idempotency·DLQ) ו-JWT — ממופים לארכיטקטורת הפלטפורמה + צ'קליסט design review ל-Tech Lead.
