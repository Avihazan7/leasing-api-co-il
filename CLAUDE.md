...
- `DECISION_LOG.md` v1.22.0 — יומן החלטות append-only: 35 החלטות (OS + ULease), רציונל וסטטוס.
...
- `AI_DATA_BI.md` v1.2.0 — יסודות BI ומידול נתונים (Power BI כמקרה לימוד, 20 נושאים): צינור BI, ETL, ה-star schema של ULease, DAX + Time Intelligence, ויזואליזציה, אינטראקטיביות, **RLS**, ותפעול כשירות (התראות · מנויי דוחות · הרשאות) — ממופה ל-M9 + הכרעת כלי ל-Tech Lead.
