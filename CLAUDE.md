...
- `MEMORY.md` v1.2.0 — שכבת זיכרון: schema, כרטיס זהות **מלא**, Active Focus/Projects, העדפות ופרוטוקול קריאה/כתיבה.
- `DECISION_LOG.md` v1.44.0 — יומן החלטות append-only: 57 החלטות (OS + ULease), רציונל וסטטוס.
