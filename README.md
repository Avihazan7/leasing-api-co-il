...
- [`DECISION_LOG.md`](./DECISION_LOG.md) v1.15.0 — Append-only decision log: 28 founding OS + ULease decisions with rationale and status.
...
- [`AI_CLAUDE_STACK_2026.md`](./AI_CLAUDE_STACK_2026.md) v1.1.0 — The 2026 Claude stack (Cowork · Projects · Skills · Code): each pillar distilled, the golden rule, the full operational build mapped in this repo, plus Agent Teams as the Ultra·Master·Max prototyping path.
