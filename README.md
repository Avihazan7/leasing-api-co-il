...
- [`DECISION_LOG.md`](./DECISION_LOG.md) v1.21.0 — Append-only decision log: 34 founding OS + ULease decisions with rationale and status.
...
- [`AI_DATA_BI.md`](./AI_DATA_BI.md) v1.2.0 — BI & data-modeling foundations (Power BI as the study case, 20 topics): the BI pipeline, ETL, ULease's star schema, DAX + time intelligence, visualization guide, interactivity, row-level security, and BI-as-a-service operations (alerts · report subscriptions · permissions · apps) — mapped to M9 with the Power-BI-vs-custom decision framed for the Tech Lead.
