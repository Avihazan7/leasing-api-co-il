...
- [`DECISION_LOG.md`](./DECISION_LOG.md) v1.2.0 — Append-only decision log: the founding OS + ULease decisions with rationale and status.
...
- [`CASES/ULEASE.md`](./CASES/ULEASE.md) v1.2.0 — ULease 🎯 Leasing.co.il business case: three-sided marketplace model + full monthly financial forecast (Jun 2026 → Dec 2027), with the reproducible model in `CASES/ULEASE_FORECAST.py`.
...
- [`CASES/ULEASE_DASHBOARD.html`](./CASES/ULEASE_DASHBOARD.html) v1.1.0 — Interactive executive dashboard (RTL): KPIs, charts (revenue/cash/deals/expenses/margin), revenue & expense mix, full forecast, and a live launch checklist; generated by `CASES/ULEASE_DASHBOARD.py`.
- [`CASES/ULEASE_AUDIT.md`](./CASES/ULEASE_AUDIT.md) v1.0.0 — End-to-end audit report (June 1, 2026): 4 parallel audit agents, 41 findings (9 critical / 21 warnings / 11 info) and a 3-wave fix plan ahead of launch and fundraising.
