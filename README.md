...
- [`CASES/ULEASE_DASHBOARD.html`](./CASES/ULEASE_DASHBOARD.html) v1.0.0 — Interactive executive dashboard (RTL): KPI cards, SVG charts, revenue mix, full forecast, team/raise, and launch status; generated by `CASES/ULEASE_DASHBOARD.py`.
