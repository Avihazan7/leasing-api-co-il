...
- [`CASES/ULEASE_DECK.md`](./CASES/ULEASE_DECK.md) v1.0.0 — ULease investor pitch deck (13 slides): Marp markdown + self-contained HTML, generated by `CASES/ULEASE_DECK.py`.
- [`CASES/ULEASE_METHODOLOGY.md`](./CASES/ULEASE_METHODOLOGY.md) v1.0.0 — ULease methodological architecture: Big Five (OCEAN) buyer-vehicle matching, Feuerstein instrumental enrichment, and game-theory pricing.
