...
## Active Modules
- [`OPERATING_SYSTEM.md`](./OPERATING_SYSTEM.md) v1.1.0 — Kernel: core doctrine, layered architecture, module registry (§3 + §3.1 working sets), the activation Boot Block, and the conflict-resolution hierarchy.
...
- [`DECISION_LOG.md`](./DECISION_LOG.md) v1.9.0 — Append-only decision log: 22 founding OS + ULease decisions with rationale and status.
...
- [`CASES/ULEASE_SPEC.md`](./CASES/ULEASE_SPEC.md) v1.4.0 — ULease end-to-end product & system spec: actors, architecture, the Ultra·Master·Max multi-agent engine, the RAG knowledge layer (§7.1), data model, integrations, and phased roadmap.
