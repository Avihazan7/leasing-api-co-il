...
## Active Modules
- [`OPERATING_SYSTEM.md`](./OPERATING_SYSTEM.md) v1.3.0 — Kernel: core doctrine, layered architecture, module registry (§3 + §3.1 working sets), the activation Boot Block, and the conflict-resolution hierarchy.
